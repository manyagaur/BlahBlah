                    ...
                    <div className="mt-28 bg-white h-[500px] w-[400px] border rounded-lg ">
                        ...
                        <h1 className="absolute left-[75px] text-center font-rubikRegular font-semibold mt-[46px] text-blue-600">
                            ...
                            <div className="grid grid-cols-12">
                                ...
                                <input className="col-span-12 rounded-md text-gray-700 border border-gray-500 h-[35px] p-2 mt-[25px] ml-2 mr-2" placeholder="Email address"></input>
                                <input className="col-span-8 rounded-md text-gray-700 border border-gray-500 h-[35px] p-2 mt-[25px] ml-2 mr-2" placeholder="Username"></input>
                                <select className="col-span-4 rounded-md border border-gray-500 text-gray-700 h-[35px] mt-[25px] ml-2 mr-2">
                                <option value="Female">Female</option>
                                <option value="Male">Male</option>
                                <option value="Others">Others</option>
                                </select>
                                <div className="col-span-12 mt-3">
                                <label className="ml-2 mt-[10px] text-gray-700 text-[12px]">Date of Birth</label>
                                </div>
                                ...
                                <button className="col-span-12 mt-6 mx-[140px] bg-blue-600 rounded-lg h-9 hover:bg-blue-700 text-white" type="submit">Sign Up</button>
                            </div>
                    </div>
                </div>
            </div>
