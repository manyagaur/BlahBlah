        ...
        <>
            <div className="flex justify-center align-middle items-center ">
                <div className="relative">
                    <div className="mt-28 bg-white h-[530px] w-[400px] border rounded-lg mx-4 ">
                        ...
                        <h1 className="absolute left-[85px] text-center font-rubikRegular font-semibold mt-[46px] text-blue-600">
                            ...
                            <div className="grid grid-cols-12">
                                ...
                                <button className="col-span-12 mt-2 mx-[140px] bg-blue-600 rounded-lg h-9 hover:bg-blue-700 text-white" type="submit">Sign Up</button>
                            </div>
                    </div>
                </div>
            </div>
